        ...
        <div>
                ...
                <div className="markets-content">
                    <div className="markets-items">
                        <ul>
                            ...
                            <li className="mark-active"><a href="./luxury">Luxury</a></li>
                        </ul>
                    </div>
                    <div className="abs">
                    </div>
                    ...
                    <a href="/contact"><button class="crypt">Contact Us</button></a>
                </div>
            ...
            <div class="mark-content">
                <div class="markets-cards">
                    ...
                    <a href="/contact"><button class="crypt-2">Contact Us</button></a>
                </div>
            </div>
        </div>
    </div>;
