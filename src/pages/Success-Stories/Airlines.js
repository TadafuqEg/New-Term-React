        ...
        <div>
                ...
                <div className="markets-content">
                    <div className="markets-items">
                        <ul>
                            ...
                            <li className="mark-active"><a href="airlines">Airlines</a></li>
                    ...
                    <a href="/contact"><button class="crypt">Talk to our experts</button></a>
                </div>
                <div className='market-owl'>
                    <div className="slider-container">
                        ...
                        <Slider className="sss" {...settings}>
                            <div>
                                <a href="">
                                    <p className='active-s'>Airlines</p>
                                </a>
                            </div>
                            <div>
                                <a href="/mass-retail">
            ...
            <div class="mark-content">
                <div class="markets-cards">
                    ...
                    <a href="/contact"><button class="crypt-2">Talk to our experts</button></a>
                </div>
            </div>
