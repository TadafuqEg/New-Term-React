        ...
        <div>
                ...
                <div className="markets-content">
                    <div className="markets-items">
                        <ul>
                            ...
                            <li className="mark-active"><a href="./theme-amusement-parks">Theme/Amusement Parks</a></li>
                    ...
                    <a href="/contact"><button class="crypt">Send Us Message</button></a>
                </div>
                <div className='market-owl'>
                    <div className="slider-container">
                        ...
                        <Slider className="sss" {...settings}>
                            <div>
                                <a href="">
                                    <p className='active-s active-s2'>Theme/Amusement Parks</p>
                                </a>
                            </div>
                            <div>
                                <a href="/fmcg">
                    ...
                    <div className='marketowl-content'>
                        <h5 class="mark-h5 mark2-h5">Theme /Amusement Parks</h5>
                        <p>A leading amusement park sought to boost visitor engagement and optimize its marketing strategies.
                        </p>
                        <a href="/contact"><button class="crypt">Send Us Message</button></a>
                    </div>
            ...
            <div class="mark-content">
                <div class="markets-cards">
                    ...
                    <a href="/contact"><button class="crypt-2">Send Us Message</button></a>
                </div>
            </div>
        </div>
    </div>;
