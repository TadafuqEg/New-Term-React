        ...
        <div>
                ...
                <div className="markets-content">
                    <div className="markets-items">
                        <ul>
                            ...
                            <li className="mark-active"><a href="./telco">Telco</a></li>
                    ...
                    <a href="/contact"><button class="crypt">Be Unique With Us, Join Now</button></a>
                </div>
            ...
            <div class="mark-content">
                <div class="markets-cards">
                    ...
                    <a href="/contact"><button class="crypt-2">Be Unique With Us, Join Now</button></a>
                </div>
            </div>
        </div>
    </div>;
