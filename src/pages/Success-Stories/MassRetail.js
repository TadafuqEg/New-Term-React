        ...
        <div>
                ...
                <div className="markets-content">
                    <div className="markets-items">
                        <ul>
                            ...
                            <li className="mark-active"><a href="mass-retail">Mass Retail</a></li>
                    ...
                    <a href="/contact"><button class="crypt">Let’s Chat</button></a>
                </div>
                <div className='market-owl'>
                    <div className="slider-container">
                        ...
                        <Slider className="sss" {...settings}>
                            <div>
                                <a href="">
                                    <p className='active-s'>Mass Retail</p>
                                </a>
                            </div>
                            <div>
                                <a href="/telco">
            ...
            <div class="mark-content">
                <div class="markets-cards">
                    ...
                    <a href="/contact"><button class="crypt-2">Let’s Chat</button></a>
                </div>
            </div>
