...
const Tactical = () => {
    ...
    return <div id='togg' className={`page ${theme}`}>
        ...
        <div className='reputation-content'>
            <Navbar />
            <div className="sec-1">
                <h2 className='amp-h amp2'>Tactical Content<br /> campaigns</h2>
                <p>We deliver strategic, high-impact content that resonates with your audience and elevates your brand</p>
                <a href='contact'><button class="book-call">Contact Us</button></a>
            </div>

            <div className="power-house amp-power">
                <div className="power-content">
                    <h5 className="amp-h2">Why Tactical Content Campaigns are Important?</h5>
                    <p className="amp-p">Why Tactical Content Campaigns are Important?
