...
const Amplification = () => {
    ...
    return <div id='togg' className={`page ${theme}`}>
        ...
        <div className='reputation-content'>
            <Navbar />
            <div className="sec-1">
                <h2 className='amp-h'>Amplification, Mitigation and<br /> fight-back Marketing Strategies</h2>
            ...
            <div className="power-house amp-power">
                <div className="power-content">
                    <h5 className="amp-h2">Why Amplification, Mitigation, and <br />Fight-Back Marketing Strategies are Important?
                    </h5>
                    <p className="amp-p">Why Amplification, Mitigation, and Fight-Back Marketing Strategies are Important?
